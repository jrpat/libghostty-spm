...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Lakr233/libghostty-spm/releases/download/storage.1.0.1777733324/GhosttyKit.xcframework.zip",
            checksum: "8b1640dd4b95fc7394302e66c59dca8b44930362705505c22b778071b8af6aef"
        ),
        .testTarget(
            name: "GhosttyKitTest",
